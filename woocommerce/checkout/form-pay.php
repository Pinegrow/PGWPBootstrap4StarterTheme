	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'st2' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'st2' ); ?></th>
			</tr>
		</thead>
		<tbody>
